...
class EvaluationCard:
    ...
    @staticmethod
    def int_to_int52(card_int):
        rank_int = EvaluationCard.get_rank_int(card_int)
        suit_int = EvaluationCard.get_suit_int(card_int)
        suit_int = np.log2(suit_int).astype("int")
        return rank_int + suit_int * 13

    @staticmethod
    def str_to_int52(card_str):
        rank_int = EvaluationCard.CHAR_RANK_TO_INT_RANK[card_str[0]]
        suit_int = EvaluationCard.CHAR_SUIT_TO_INT_SUIT[card_str[1]]
        suit_int = int(np.log2(suit_int))
        return rank_int + suit_int * 13
